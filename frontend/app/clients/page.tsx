...
export default function DirectImportPage() {
  ...
  const template = useMemo(() => {
    return [
      "19.01.2026\tEwheel Murcia\t285.53\tCHF\t1\t1530\t1020\t\t",
      "11.01.2026\tShopify\t136.87\tCHF\t1\t6570\t1020\tVB81\t6570",
      "24.01.2026\tKaufland Waldshut-Tiengen (DE)\t124.09\tCHF\t1\t6500\t1020\tVB81\t6500",
      "07.01.2026\tCoop Pronto AG Bulle – Treibstoff\t103.61\tCHF\t1\t6210\t1020\tVB81\t6210",
      "08.01.2026\tSumUp Payments Limited\t57.92\tCHF\t1\t1020\t1093\t\t",
    ].join("\n");
  }, []);
        ...
        <CardContent className="space-y-5">
          ...
          <div className="rounded-xl border border-[color:var(--bp-border)] bg-white p-4">
            ...
            <div className="mt-2 text-sm text-slate-600">
              Columns: <span className="font-mono">date, text, amount, currency, fx, debit, credit, vatCode?, vatAccount?</span>
            </div>
            <div className="mt-3 flex flex-wrap gap-2">
              <Button
                ...
                onClick={() => {
                  setPaste(template);
                  setMessage("Template inserted — replace with your real data.");
                }}
              >
                Insert Template
              </Button>
